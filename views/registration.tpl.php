...
<main class="main">
    <div class="container">
        <form method="post" action="/registration">
            ...
            <div class="g-recaptcha" data-sitekey="6LfycYIpAAAAALXpH8Ki6gTg07p4lCR3G5xzVBdz"
                 data-callback="onRecaptchaSuccess"></div>
            <button type="submit" class="btn btn-primary" id="submitBtn" disabled>Регестрация</button>
        </form>
        <?php if (!empty($message)): ?>
            <div class="text-danger bg-dark p-2 col-md-4 offset-md-4"
                 style="text-align:center; font-size: 21px"><?= $message ?></div>
        <?php endif; ?>
    </div>
</main>
